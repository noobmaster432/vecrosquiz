...
const AdminPage = () => {
    ...
    const fetchUserData = async () => {
      ...
      try {
        const response = await axios.get(
          `${process.env.REACT_APP_BACKEND_URI}/api/auth/me`,
          {
  ...
  const fetchTests = async () => {
    ...
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_BACKEND_URI}/api/tests`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        `${process.env.REACT_APP_BACKEND_URI}/api/tests/create`,
        testData,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const handleDelete = async (testId) => {
    ...
    try {
      await axios.delete(
        `${process.env.REACT_APP_BACKEND_URI}/api/tests/${testId}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
